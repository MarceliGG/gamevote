...
export async function GET() {
  ...
  await sql`CREATE TABLE IF NOT EXISTS Games (company_id INTEGER REFERENCES Companies(id) UNIQUE, name VARCHAR(100), website VARCHAR(253), type VARCHAR(20), premiere_date DATE, description TEXT, votes INTEGER)`;
